          ...
          <div className="bg-white rounded-2xl shadow-xl p-6">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 mb-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-xl font-bold text-gray-900">AI Price Analysis</h2>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 text-center">
                <div>
                  <div className="text-2xl font-bold text-gray-700">
                    ${Math.round(pricingStrategy.minimumAcceptable)}
                  </div>
                  <div className="text-xs text-gray-500">Minimum Price</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-gray-700">
                    {((pricingStrategy.listingPrice / pricingStrategy.minimumAcceptable - 1) * 100).toFixed(0)}%
                  </div>
