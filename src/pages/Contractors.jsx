...
const Contractors = () => {
  const vertical = verticals.contractors;
      ...
      <div className="bg-slate-900 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-white mb-4">Works Across All Remodel Types</h2>
            <p className="text-xl text-slate-400">Turn demolition debris into revenue opportunities</p>
          </div>
