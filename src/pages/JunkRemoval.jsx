...
const JunkRemoval = () => {
  const vertical = verticals.junkRemoval;
      ...
      <div className="bg-slate-900 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-white mb-4">Perfect For Every Job Type</h2>
            <p className="text-xl text-slate-400">From residential cleanouts to commercial demolition</p>
          </div>
