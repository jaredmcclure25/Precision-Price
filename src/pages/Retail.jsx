...
const Retail = () => {
  const vertical = verticals.retail;
      ...
      <div className="bg-slate-900 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-white mb-4">Perfect For Every Seller</h2>
            <p className="text-xl text-slate-400">From casual resellers to professional dealers</p>
          </div>
